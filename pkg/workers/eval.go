...
func wrapEvalCJS(source string, asFunction bool) string {
	...
	b.WriteString("  var __esm = __e && typeof __e === \"object\" && __e.__esModule;\n")
	b.WriteString("  if (__esm && \"default\" in __e) {\n")
	...
	b.WriteString("      var __names2 = Object.getOwnPropertyNames(__e);\n")
	b.WriteString("      for (var __j = 0; __j < __names2.length; __j++) {\n")
	b.WriteString("        (function (k) { if (k !== \"default\") __vite_ssr_exportName__(k, function () { return __e[k]; }); })(__names2[__j]);\n")
	b.WriteString("      }\n")
	b.WriteString("    }\n")
	b.WriteString("  }\n")
	b.WriteString("}\n")
